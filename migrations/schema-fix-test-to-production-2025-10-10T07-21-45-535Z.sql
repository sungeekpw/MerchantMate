...
-- Generated: 2025-10-10T07:21:45.535Z
-- Total statements: 8

BEGIN;

CREATE SEQUENCE IF NOT EXISTS fee_group_fee_items_id_seq;
...
CREATE SEQUENCE IF NOT EXISTS fee_groups_id_seq;
...
CREATE SEQUENCE IF NOT EXISTS fee_item_groups_id_seq;
...
CREATE SEQUENCE IF NOT EXISTS fee_items_id_seq;
