...
import { CreditCard, BarChart3, Store, Users, Receipt, FileText, LogOut, User, MapPin, Shield, Upload, UserPlus, DollarSign, ChevronLeft, ChevronRight, Monitor, ChevronDown, ChevronUp, Book, TestTube, Mail, Crown, Building2, Bell } from "lucide-react";
...
const baseNavigation = [
  ...
  { name: "Alerts", href: "/alerts", icon: Bell, requiresRole: ['admin', 'super_admin'] },
