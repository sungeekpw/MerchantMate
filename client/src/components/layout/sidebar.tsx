...
import { CreditCard, BarChart3, Store, Users, Receipt, FileText, LogOut, User, MapPin, Shield, Upload, UserPlus, DollarSign, ChevronLeft, ChevronRight, Monitor, ChevronDown, ChevronUp, Book, TestTube, Mail, Crown, Building2 } from "lucide-react";
...
const baseNavigation = [
  ...
  { name: "Acquirers", href: "/acquirers", icon: Building2, requiresRole: ['admin', 'super_admin'] },
